...
export function makePlayer(overrides: Partial<PlayerState> & { roleId?: string } = {}): PlayerState {
  playerCounter++
  return {
...
export function makeState(overrides: Partial<GameState> & { players?: PlayerState[] } = {}): GameState {
  return {
