...
const undertakerNightSteps: NightStepDefinition[] = [
  {
...
function UndertakerNightAction({ game, state, player, onComplete }: NightActionProps) {
...
export default defineRole({
  ...
  nightSteps: undertakerNightSteps,
  NightAction: UndertakerNightAction,
})
