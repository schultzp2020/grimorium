const en = {
  ...
  deflectDescription: 'The Demon targeted {target}, but their kill was deflected. Choose who dies instead.',
  ...
  selectBluffsDescription: 'Choose 3 good roles not in play. These will be shown to the Demon as safe bluffs.',
