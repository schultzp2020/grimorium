    ...
    >
      ...
      <div className='min-w-0 flex-1'>
        <div className='flex items-center gap-2'>
          <div className={cn('font-medium text-sm', isDead ? 'text-parchment-500 line-through' : 'text-parchment-100')}>
            {player.name}
          </div>
...
export function Grimoire({ state, compact = false, onPlayerSelect, onShowRoleCard, onEditEffects }: Props) {
