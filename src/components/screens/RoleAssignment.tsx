      ...
      <div className="flex-1 px-4 py-4 max-w-lg mx-auto w-full overflow-y-auto">
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-4 mb-4">
          ...
          <div className="flex items-start gap-2 mb-2">
            ...
            <span className="text-xs text-parchment-400 line-clamp-2">{players.join(", ")}</span>
          </div>
        ...
        {showCustomize && (
          <div>
            <div className="flex items-center justify-between mb-3">
              <p className="text-parchment-500 text-xs">{t.newGame.tapToAssign}</p>
              ...
              {players.map((playerName) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span className="text-parchment-100 font-medium text-sm">{playerName}</span>
                      {role ? (
