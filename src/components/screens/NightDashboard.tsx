    ...
    <div className="min-h-app bg-gradient-to-b from-indigo-950 via-grimoire-purple to-grimoire-darker flex flex-col">
      ...
      <div className="bg-gradient-to-b from-indigo-900/50 to-transparent px-4 py-4">
        <div className="max-w-lg mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-parchment-400 text-sm">{t.game.nightDashboardDescription}</p>
          </div>
        </div>
      </div>
      ...
      >
        <DialogContent>
          ...
          <DialogBody>
            {reviewPlayer && (
              <p className="text-parchment-300 text-sm mb-3 font-medium">{reviewPlayer.name}</p>
            )}
            {reviewMessages.length === 0 ? (
              <p className="text-parchment-500 text-sm">{t.game.noActionRecorded}</p>
            ) : (
              <div className="space-y-2">
                {reviewMessages.map((msg, i) => (
                  <div key={i} className="text-parchment-300 text-sm bg-white/5 rounded-lg p-3">
