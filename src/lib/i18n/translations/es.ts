...
const es: Translations = {
  ...
  game: {
    ...
    returnDeviceDescription: 'Por favor, devuelve el dispositivo antes de continuar.',
    ...
    setupActionsSubtitle: 'Configura los roles que necesitan preparación del cuentacuentos antes de comenzar',
