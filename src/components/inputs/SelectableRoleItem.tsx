...
interface SelectableRoleItemProps {
  playerName: string
  roleName: string
  roleIcon: IconName
  isSelected: boolean
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isSelected ? 'bg-mystic-gold/20 border-mystic-gold/50' : 'bg-white/5 border-white/10 hover:bg-white/10',
      )}
    >
      <div className='flex items-center gap-3'>
        <Icon name={roleIcon} size='md' className={isSelected ? 'text-mystic-gold' : 'text-parchment-400'} />
