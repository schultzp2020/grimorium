      ...
      <div className="bg-gradient-to-b from-mystic-gold/10 to-transparent px-4 py-4">
        <div className="max-w-lg mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-parchment-400 text-sm">{t.game.roleRevelationDescription}</p>
  ...
  return (
    ...
    >
      ...
      >
        {role ? (
          <Icon
            name={role.icon}
            size="md"
            className={cn(isRevealed ? "text-parchment-500" : team?.colors.text)}
          />
        ) : (
      ...
      <div className="flex-1 min-w-0">
        ...
        {role && (
          <span className={cn("text-xs", isRevealed ? "text-parchment-600" : team?.colors.text)}>
            {roleName}
          </span>
        )}
      </div>
