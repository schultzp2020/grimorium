      ...
      <div className="bg-gradient-to-b from-mystic-gold/10 to-transparent px-4 py-4">
        <div className="max-w-lg mx-auto">
          <div className="text-center">
            ...
            <p className="text-parchment-400 text-sm">{t.game.setupActionsSubtitle}</p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-2">
          {setupItems.map((item) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="font-medium text-sm text-parchment-100">{item.playerName}</div>
          ...
          {allDone && (
            <div className="text-center py-8">
              <Icon name="checkCircle" size="xl" className="text-emerald-500 mx-auto mb-2" />
              <p className="text-parchment-400 text-sm">{t.game.allSetupActionsComplete}</p>
            </div>
          )}
        </div>
      </div>
